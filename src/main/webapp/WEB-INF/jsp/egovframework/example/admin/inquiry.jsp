									...
									<tbody>
										<c:forEach var="result" items="${inquiryList}">
											<tr>
												...
												<td onclick="location.href='/holdem/admin/inquiryInfo.do?idx=${result.idx}'" style="cursor:pointer;"><fmt:formatDate value="${result.answerDate}" pattern="yyyy-MM-dd HH:mm"/></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
