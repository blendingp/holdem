...
<body>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group">
													<label>상단 고정</label>
													<div class="radio">
														<label class="radio-inline"><input type="radio" name="topYn" value="Y" >Y</label>
														<label class="radio-inline"><input type="radio" name="topYn" value="N" checked>N</label>
													</div>
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													<label>노출 여부</label>
													<div class="radio">
														<label class="radio-inline"><input type="radio" name="expsYn" value="Y" checked>Y</label>
														<label class="radio-inline"><input type="radio" name="expsYn" value="N" >N</label>
													</div>
												</div>
											</div>
										</div>
					...
					<button type="button" onclick="noticeInsert()" class="btn btn-outline btn-default">등록</button>
				</div>
			</div>
		</div>
	</div>
	...
	function noticeInsert(){
		...
		$.ajax({
			...
			url:'/holdem/admin/noticeInsert.do',
