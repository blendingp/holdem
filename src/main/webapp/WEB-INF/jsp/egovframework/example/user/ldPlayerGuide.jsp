			...
			<div class="body">
				...
				<div class="quedetail">
					<div class="table-19">
						<div class="guidebox">
							<div class="extext">
								<span>1.</span> Google, naver, daum 등 시작페이지에서 LD플레이어를 검색하여, 홈페이지로 접속합니다.
							</div>
							...
							<div class="extext">
								2. download LDPlayer를 클릭합니다.
								<a href="/ldplayer_kr_1511_ld.exe" download>LD Player 바로 다운로드</a> 
							</div>
							<div class="div-block-12">
							...
							<div class="extext-copy">3. 다운로드 받은 파일을 실행시킵니다.</div>
							<div class="extext">4. 즉시 설치를 눌러 LD플레이어 설치를 완료합니다.</div>
							<div class="div-block-12">
							...
							<div class="extext">5. 설치가 완료되면 시작하기를 클릭합니다.</div>
							<div class="div-block-12">
							...
							<div class="extext">6. vvingame.com 홈페이지 하단에서 Google Play 다운로드 버튼을 클릭합니다.</div>
							<div class="div-block-12">
							...
							<div class="extext">7. 설치된 파일을 우클릭하여 압축 풀기를 실행합니다.</div>
							<div class="div-block-12">
								<img src="/holdem/webflow/images/ex6.png" loading="lazy" alt="" class="exlmage">
							</div>
							<div class="extext">8. 압축풀기를 클릭하여 진행합니다.</div>
							<div class="div-block-12">
								<img src="/holdem/webflow/images/ex7.png" loading="lazy" alt="" class="exlmage">
							</div>
							<div class="extext-copy">9. 압축을 해제한 폴더로 들어가서 apk 파일을 더블클릭합니다.</div>
							<div class="extext">
								10. 자동으로 LD플레이어와 연결되어 LD플레이어 창이 열리고, 
								<br>잠시 후에 Holdem 파일이 화면에 생성됩니다. 이 파일을 실행하여 게임을 시작하면 됩니다.
							</div>
							<div class="div-block-12">
