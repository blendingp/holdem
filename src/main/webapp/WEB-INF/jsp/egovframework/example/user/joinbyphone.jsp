    ...
    if( iReturn == 0 )
    {
        ...
        if(!sRequestNumber.equals(session_sRequestNumber))
        {
        	...
        	<script>
        		...
        		console.log("sName:"+sName+" sDupInfo:"+sDupInfo +" sGender:"+sGender+" mobile:"+mobile);
                ...
                opener.parent.location = "/holdem/user/join.do?birthDate="+sBirthDate+"&uid="+sDupInfo+"&autchTick="+tick;
                self.close();
                //아작스로 폰번호 가진 사람 조회
/*                 jQuery.ajax({
                    type:"POST",
                    //url :"/holdem/insertAuth.do?midx=" +midx+"&birthDate="+sBirthDate+"&uid="+sDupInfo+"&autchTick="+tick,
                    url:"/holdem/user/join.do?birthDate="+sBirthDate+"&uid="+sDupInfo+"&autchTick="+tick,
                    dataType:"json",
